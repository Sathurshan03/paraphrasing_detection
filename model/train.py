from model.arch.RNN_FastText import RNN_FastText
import torch
...
from model.data.dataset_paraphrase import DatasetParaphrase
from model.data.data_server import DataServer
